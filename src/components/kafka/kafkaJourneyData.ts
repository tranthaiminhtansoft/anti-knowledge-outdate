...
const chapterRegistry: KafkaChapter[] = [
  ...
  },
  {
    ...
    glossary: [
      ...
      { term:'Leader', location:'Một replica của partition', role:'Replica nhận mọi write; read mặc định từ leader nhưng có thể từ follower đủ điều kiện khi cấu hình follower fetching.' },
    ...
    steps: [
      ...
      { title:'Offset', text:'Offset là vị trí record trong partition; committed offset lưu tiến độ từng consumer group và cho phép resume/replay.', activeNodes:['consumer'], metrics:{current_record:'1842',position:'1843',committed:'1843'}, log:'OffsetCommit orders-1=1843' },
