...
const strategies: Record<Strategy, { label: string; summary: string; nodes: Array<[string, string, string]> }> = {
  ...
  sentinel: { label: 'Sentinel', summary: 'Nhiều Sentinel giám sát, xác nhận lỗi và tự đưa replica lên primary.', nodes: [['Primary', 'WRITE', 'primary'], ['Replica', 'FAILOVER', 'replica'], ['Sentinel', 'MONITOR', 'sentinel']] },
  cluster: { label: 'Cluster', summary: 'Nhiều primary sở hữu hash slot; replica bảo vệ từng shard để scale ngang.', nodes: [['Primary A', '0–5460', 'primary'], ['Primary B', '5461–10922', 'primary'], ['Primary C', '10923–16383', 'primary']] },
};
const components = [
